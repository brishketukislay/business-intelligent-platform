...
import {
  createTrackerAction as createTrackerActionImpl,
} from "./tracker-setup-actions";

export async function createTrackerAction(
  ...args: Parameters<typeof createTrackerActionImpl>
): Promise<Awaited<ReturnType<typeof createTrackerActionImpl>>> {
  return createTrackerActionImpl(...args);
}
