/*
  ...
  - You are about to drop the column `isPeriodInput` on the `InputDefinition` table. All the data in the column will be lost.
...
INSERT INTO "new_InputDefinition" ("category", "createdAt", "description", "id", "isRequired", "key", "modelId", "name", "status", "type", "unit") SELECT "category", "createdAt", "description", "id", "isRequired", "key", "modelId", "name", "status", "type", "unit" FROM "InputDefinition";
